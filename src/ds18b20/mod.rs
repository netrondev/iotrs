...
use crate::onewire::crc::check_crc8;
use crate::onewire::{self, Address, OneWire, OneWireError, OneWireResult};
    ...
    T: OutputPin<Error = E>,
{
    ...
    let max_retries = (10000 / onewire::READ_SLOT_DURATION_MICROS) + 1;
